...
class DailyRecordMapper {
    ...
    fun toDomain(entity: DailyRecordEntity): DailyRecord {
        ...
        return DailyRecord(
            ...
            status = status,
            meals = com.goings.dayzero.domain.model.MealSortPolicy.sortMeals(meals),
    ...
    fun toEntity(domain: DailyRecord, ownerLocalId: String = "local_uninitialized"): DailyRecordEntity {
        val sortedMeals = com.goings.dayzero.domain.model.MealSortPolicy.sortMeals(domain.meals)
