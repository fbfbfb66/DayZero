...
object MediaAssetMapper {
    fun toDomain(entity: MediaAssetEntity): MediaAsset {
        return MediaAsset(
            ...
            remoteSyncState = MediaRemoteSyncState.fromRaw(entity.remoteSyncState),
            remoteMasterPath = entity.remoteMasterPath,
            remoteThumbnailPath = entity.remoteThumbnailPath
        )
    }
