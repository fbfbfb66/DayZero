...
abstract class DayZeroDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        internal val MIGRATION_12_13 = object : Migration(12, 13) {
            override fun migrate(db: SupportSQLiteDatabase) {
                Log.d("DayZeroSync", "room migration start 12->13")
                try {
                    db.execSQL("ALTER TABLE media_assets ADD COLUMN remoteSyncState TEXT NOT NULL DEFAULT 'LOCAL_ONLY'")
                    db.execSQL("ALTER TABLE media_assets ADD COLUMN remoteMasterPath TEXT")
                    db.execSQL("ALTER TABLE media_assets ADD COLUMN remoteThumbnailPath TEXT")
                    ...
                    Log.d("DayZeroSync", "room migration success 12->13")
                } catch (e: Exception) {
                    Log.e("DayZeroSync", "room migration error 12->13", e)
                    throw e
                }
            }
        }
