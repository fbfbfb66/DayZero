...
import com.goings.dayzero.data.sync.chat.ChatConversationMergeStats
import com.goings.dayzero.data.sync.chat.ChatMessageMergeStats
...
import com.goings.dayzero.data.sync.chat.ChatPullResult
...
class InProcessSyncSchedulerChatPullTest {
    ...
    private fun createScheduler(
        ...
        chatBackfillCoordinator: com.goings.dayzero.data.sync.chat.ChatBackfillCoordinator = mockk(relaxed = true),
