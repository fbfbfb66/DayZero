package com.goings.dayzero.domain.ai

import com.goings.dayzero.domain.model.ai.HybridIntent
import com.goings.dayzero.domain.model.ai.HybridIntentContext
...
import com.goings.dayzero.domain.model.ai.RecentMessageItem
...
class HybridIntentRouter(
    ...
    suspend fun classify(
        ...
        val hasPreviousAssistantReply = context.recentMessages.any { it.role == com.goings.dayzero.domain.model.ai.ChatRole.Assistant }
