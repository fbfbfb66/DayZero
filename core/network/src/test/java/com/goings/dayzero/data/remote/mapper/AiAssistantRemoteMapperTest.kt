...
import com.goings.dayzero.data.remote.dto.assistant.AiChatCardDto
...
import com.goings.dayzero.data.remote.dto.assistant.AssistantActionItemDto
...
class AiAssistantRemoteMapperTest {
    ...
    fun roundTrip_preservesZeroAndNullNutritionSeparately() {
        val card = ShowConfirmCardPayload(
            ...
            items = emptyList(),
            meals = listOf(
                com.goings.dayzero.domain.model.ai.assistant.ConfirmCardMeal(
                    mealType = "lunch",
                    mealLabel = "Lunch",
    ...
    fun actionResponseMapper_parsesNutritionFieldsCorrectly() {
        val actionDto = AssistantActionDto(
            ...
            payload = AssistantActionPayloadDto(
                ...
                originalText = "吃了香蕉",
                buttons = listOf(
                    com.goings.dayzero.data.remote.dto.assistant.AssistantActionOptionDto("confirm", "确认"),
                    com.goings.dayzero.data.remote.dto.assistant.AssistantActionOptionDto("cancel", "取消")
                ),
                items = listOf(
