...
import { normalizeActions as normalizeFallbackActions } from "../assistant-turn-v2/normalization.ts";
...
Deno.test("streaming and fallback normalization produce the same output for the same fixture", () => {
  ...
  normalizeActions(streamActions, "2026-06-26", "banana", { weightKg: 68 });
  normalizeFallbackActions(fallbackActions, "2026-06-26", "banana", {
    weightKg: 68,
  });
