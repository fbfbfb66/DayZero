...
- **End-to-End Sync Verification**: Added the "Real Supabase Verification Checklist" to `docs/SUPABASE_SCHEMA_VERIFICATION.md` to formally document and test end-to-end data fidelity, canonical schema compatibility, and partial pull handling on real devices.
