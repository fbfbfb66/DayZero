...
object SupabaseConfig {
    ...
    const val SUPABASE_PUBLISHABLE_KEY = "sb_publishable_MjQ5MzJkYmUtMTk1Ny00OWVmLTg3ZjMtMmUwZjYzODZlYTMxX3N5YmVueG14bnd3dGx2a2VvanRq" // I will use the actual key if I can find it, for now using a placeholder if not provided. 
