...
class HybridIntentRouter(
    ...
    private fun logRouting(
        ...
        Log.d(TAG, "--- Intent Routing Log ---")
        Log.d(TAG, "raw text: '$rawText'")
        Log.d(TAG, "local hard rule matched: $localMatched")
        Log.d(TAG, "remote classifier called: $remoteCalled")
        Log.d(TAG, "primaryIntent: ${result.primaryIntent}")
        Log.d(TAG, "speechAct: ${result.speechAct}")
        Log.d(TAG, "consumptionStatus: ${result.consumptionStatus}")
        Log.d(TAG, "shouldCreateDraft: ${result.shouldCreateDraft}")
        Log.d(TAG, "shouldAskMealTime: ${result.shouldAskMealTime}")
